#include <iostream>
#include <vector>   //When using a vector, include the vector header
using namespace std;

/*
Section 7: Challenge

Write C++ program as follows:

Declare 2 empty vectors of integers named vector 1 and vector 2, 
respectively
